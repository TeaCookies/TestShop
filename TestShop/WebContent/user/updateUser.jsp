...
// 				history.go(-1);
		...
		function fncUpdateUser() {
			...
			if( $("input:text[name='addr1']").val() != ""  &&  $("input:text[name='addr2']").val() != "" &&  $("input:text[name='addr3']").val() != "") {
				var value = $("input[name='addr1']").val() + " " 
									+ $("input[name='addr2']").val() + ", " 
									+ $("input[name='addr3']").val();
			}
			$("input:hidden[name='addr']").val( value );
	...
	<div class="container">
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
			      <input type="text"  class="form-control" id="sample6_postcode" name="addr1" placeholder="우편번호" readonly>
					<input type="text"  class="form-control"id="sample6_address" name="addr2" placeholder="주소" readonly >
					<input type="text" class="form-control" id="sample6_detailAddress" name="addr3"placeholder="상세주소">
